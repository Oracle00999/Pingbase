      ...
      <div className="relative z-10 hidden lg:block">
        <div className="max-w-md">
          ...
          <h1 className="text-4xl font-bold leading-tight">
            Start watching your APIs in minutes.
          </h1>
          <p className="mt-4 text-base leading-7 text-slate-600">
            Create your account, get a workspace automatically, then add your
            first monitor when you land in the dashboard.
          </p>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <p className="mt-2 text-sm leading-6 text-slate-600">
            Your first workspace is created automatically after signup.
          </p>
        </div>
